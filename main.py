...
application = webapp2.WSGIApplication([
    ...
    ('/partner/cancel_modal',partners.CancelModal),
    ...
    ('/admin/evaluations/extension', admin_eval.ExtendEvals),
    ('/admin/evaluations/view', admin_eval.ViewEvals),
    ('/admin/partners/add', admin_partnership.AddPartnership),
    ('/admin/partners/add/solo', admin_partnership.AddSoloPartnership),
    ...
    ('/admin/roster/pictures', admin_roster.UploadPictures),
